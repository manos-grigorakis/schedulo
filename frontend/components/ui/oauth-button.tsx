...
export default function OAuthButton({ provider, icon }: OAuthButtonProps) {
  ...
  return (
    <button
      onClick={handleOAuth}
      className="flex items-center justify-center w-full gap-3 px-4 py-3 text-sm font-medium transition-colors bg-white border cursor-pointer rounded-xl border-neutral-900/10 text-neutral-900 hover:bg-neutral-50"
    >
